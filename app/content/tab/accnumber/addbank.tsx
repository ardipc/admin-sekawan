...
export default function BtnBank({ fetchBanks }: { fetchBanks: any; }){
    ...
    return(
        <>
        {/* @ts-ignore */}
            <button className='btn btn-primary text-white font-bold rounded-none' onClick={()=> openModal()}> <img src="/icons/tambah-wt.svg" alt="tambah" /> Add Account Number</button>
            <dialog id="modal_tambah_bank" className="modal">
                <form onSubmit={handleSubmit(onSubmit)} method="dialog" className="modal-box rounded-none">
                    <div className="flex gap-2 items-center">
                        ...
                        <p className="text-3xl font-bold">Add Akun Number</p>
                    </div>
