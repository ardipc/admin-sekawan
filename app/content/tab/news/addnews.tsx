...
export default function AddNews({ setActive }: { setActive: any; }){
    ...
    const onSubmit: SubmitHandler<Skema> = async (data) => {
        ...
        const insert = await supabase.from('news').insert([payload]).select();
        if(insert) {
            setActive(0);
        }
    }
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-5">
                <div className="flex justify-between">
                    <div className="flex gap-2 items-center">
                        ...
                        <p className="text-3xl font-bold">Add News</p>
                    </div>
                ...
                <div className="my-7">
                    ...
                    <div className="form-control w-full max-w-xs mt-4">
                        ...
                        <Select onChange={(value: any) => changeSelect(value)} options={categories} theme={(theme) => ({
                            ...theme,
                            borderRadius: 0,
                        })} />
                    </div>
                    <div className="form-control w-full max-w-xs mt-4">
                        ...
                        <CreatableSelect isMulti onChange={(value: any) => changeMultiSelect(value)} options={[]} theme={(theme) => ({
                            ...theme,
                            borderRadius: 0,
                        })} />
                    </div>
