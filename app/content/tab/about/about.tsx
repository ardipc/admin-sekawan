...
export default function AboutJIS(){
    return(
        <>
            <section className="p-6">
                <div className="flex justify-between">
                    <div className="flex gap-2 items-center">
                        ...
                        <p className="text-3xl font-bold">About JIS</p>
                    </div>
                ...
                <div className="mt-4 flex flex-col items-center">
                    ...
                    <div className="form-control w-full mt-4 max-w-md">
                        <label className="label">
                            <span className="text-2xl font-bold"><span className="text-primary">*</span> Link</span>
                        </label>
