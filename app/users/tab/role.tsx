...
import { useManagers } from "@/libs/hooks/useUser";
...
export default function Admin() {
  ...
  const fetchUsers = async () => {
    setIsLoad(true);
    const { users, error } = await useManagers();
      ...
      <div className="content p-6">
        <div className="flex justify-between">
          <div className="flex gap-2 items-center">
            ...
            <p className="text-3xl font-bold">All Manager</p>
          </div>
        </div>
          ...
          <table className="table">
            ...
            <thead className="py-4 px-6 bg-primary/10 border-primary border-2">
              <tr>
                ...
                <th className="text-primary font-bold text-sm">Manager</th>
